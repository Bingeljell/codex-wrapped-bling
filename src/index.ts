...
function printHelp() {
  console.log(`
codex-wrapped-christmas v${VERSION}

Generate your Codex year in review stats card.

USAGE:
  codex-wrapped-christmas [OPTIONS]
...
async function main() {
  ...
  if (values.version) {
    console.log(`codex-wrapped-christmas v${VERSION}`);
    process.exit(0);
  }
  ...
  const filename = `codex-wrapped-christmas-${requestedYear}.png`;
